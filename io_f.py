...
def read_path_data(path_file, idx):
    ...
    return pd.DataFrame(metadata, index=[idx]), pd.DataFrame(sensor_data).T
...
def get_sensor_values(
    df, sensor_names, with_ts=False, reset_index=False, to_val=False, dropna=True
):
